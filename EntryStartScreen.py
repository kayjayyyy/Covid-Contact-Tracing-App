...
class StartScreen(tk.Tk):
    ...
    def init(self):
        ...
        question_4_label = tk.Label(self, text="Cough or sore throat?", font=("Source Sans Pro", 11, "bold"), background="#E3DAFF")
        question_4_label.place(x=80, y=375)
        ...
        question_5_label = tk.Label(self, text="Shortness of breath?", font=("Source Sans Pro", 11, "bold"), background="#E3DAFF")
        question_5_label.place(x=80, y=405)
